...
export default function AllBlogs() {
    ...
    const handleSearch = (e) => {
        ...
        axios.get(`https://let-s-blog-server.vercel.app/api/blogs?q=${searchText}&category=${filterText}`)
            .then(res => {
    ...
    const handleFilter = (category) => {
        ...
        axios.get(`https://let-s-blog-server.vercel.app/api/blogs?&category=${category}`)
            .then(res => {
                setFilterBlogs(res.data);
            }).catch(err => {
