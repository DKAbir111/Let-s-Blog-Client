        ...
        <div className=" bg-white rounded-sm shadow-lg overflow-hidden font-lato">
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-center mt-4">
                    <Link className="text-sm text-[#b28b51] hover:text-black flex items-center gap-1"><FaBookOpenReader /> Read More</Link>
                    <button className="text-sm text-[#b28b51] hover:text-black flex items-center gap-1">
                        <FaHeart />  Wish List
                    </button>
                </div>
            </div>
